...
| `meilisearch` | `meilisearch/open-api` | `a2bd2133ac9f9b85fca8fb8b1aa69063c8f1002c` | `open-api.json` | `83cbd10cea1ca75590dc31f1d2e40ef2b636297d47b39c9aefd813e41454cfd1` | Reject `E007` (OpenAPI 3.1.0; clears the gate, real pipeline) |
...
past the gate, rejecting on non-disjoint `integer | number` unions (`E007`).
